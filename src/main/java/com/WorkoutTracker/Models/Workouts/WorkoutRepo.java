...
//    List<WorkoutModel> findByUserIdAndWeekdayId(Integer userId, Integer weekdayId);
    ...
    @Query("SELECT w FROM WorkoutModel w WHERE w.user_id = :userId AND w.workoutdate = :workoutdate")
    List<WorkoutModel> findByUserIdAndWorkoutdate(Integer userId, LocalDate workoutdate);
